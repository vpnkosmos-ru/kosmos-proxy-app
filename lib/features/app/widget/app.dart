...
class App extends HookConsumerWidget with WidgetsBindingObserver, PresLogger {
  ...
  void onResume(WidgetRef ref) {
    ...
    // Return from the payment cabinet must reconcile against server metadata,
    // not reactivate a cached profile. The saved URL remains intact if this
              ...
              builder: (ColorScheme? lightColorScheme, ColorScheme? darkColorScheme) {
                return MaterialApp.router(
                  ...
                  builder: (context, child) {
                    ...
                    if (Release.read().allowCustomUpdateChecker) {
                      child = UpgradeAlert(
                        upgrader: upgrader,
