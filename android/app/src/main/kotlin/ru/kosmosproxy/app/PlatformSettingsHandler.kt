...
import ru.kosmosproxy.app.Application.Companion.packageManager
...
class PlatformSettingsHandler : FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware,
    ...
    companion object {
        const val channelName = "ru.kosmosproxy.app/platform"
        ...
        enum class Trigger(val method: String) {
            ...
            GetActiveNetworkTransport("get_active_network_transport"),
            GetBaseNetworkTransport("get_base_network_transport"),
        }
    }
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            Trigger.GetActiveNetworkTransport.method, Trigger.GetBaseNetworkTransport.method -> {
                // Kept under the legacy method name for compatibility. Both
                // calls return the physical validated base transport, never
                // Android's VPN overlay transport.
                result.runCatching { success(BaseNetworkTransportMonitor.transport()) }
            }
